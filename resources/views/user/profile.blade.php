...
@section('content')
    ...
    <div class="panel"
         ...
         @if($user->profile_image_url != "")
            <img src="{{ $user->profile_image_url }}" class="img-thumbnail img-responsive center-block form-spacing-top" width="200">
         @else
         ...
         <div class="row">
             <div class="col-md-6">
                 ...
                 <li class="user-info"><a href="{{ url('blog/'.$post->slug) }}">{{ $post->title }}</a></li>
                 @endforeach
                 </ul>
                 <p class="user-info">Quantity of added comments: {{ $comments }}</p>
             </div>
         </div>
    </div>
