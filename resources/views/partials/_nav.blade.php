                ...
                @if (Auth::check())
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="{{ url('user/profile/Auth::user()->id')}}"><i
                                            class="fa fa-user men-style"></i> My
                                    Profile</a></li>
                            <li><a href="{{ route('posts.index') }}"><i
                                            class="fa fa-newspaper-o men-style"></i>
                                    Posts</a></li>
                            <li><a href="{{ route('categories.index')}}"><i
                                            class="fa fa-paperclip men-style"></i>
                                    Categories</a></li>
                            <li><a href="{{ route('tags.index')}}"><i
                                            class="fa fa-tags men-style"></i>
                                    Tags</a></li>
                            <li><a href="{{ route('settings')}}"><i
                                            class="fa fa-spin fa-cog men-style"></i>
                                    Settings</a></li>
                ...
                @else
                    ...
                    <li><a href="{{ route('login')}}"
                           class="btn btn-block btn-default"><i
                                    class="fa fa-sign-in men-style"></i>
                            Login</a></li>
                @endif
            </ul>
